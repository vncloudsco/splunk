...
class BuiltinSSLAdapter(Adapter):
    ...
    password = None
    """The password for the server's private key (if encrypted)."""
    ...
    def __init__(
        ...
        super(BuiltinSSLAdapter, self).__init__(
            certificate, private_key, certificate_chain, ciphers, password
        )
        ...
        self.context.load_cert_chain(certificate, private_key, password)
